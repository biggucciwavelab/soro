...
//using namespace postprocess; //Added by Esteban. Gnuplot capabilities are a part of postprocess namespace.
...
int main(int argc, char* argv[]) {
    ...
    SetChronoDataPath("C:/Chrono/Chrono_builds/Chrono_develop/bin/data/");
    ...
    ChIrrApp application(&mphysicalSystem, L"A simple project template", core::dimension2d<u32>(1000, 800),
    ...
    pendulumBody->SetPos_dt(ChVector<>(2, 0, 0));
    ...
    //Preparing data collection. Change this file location to wherever you want the data stored.
    std::string datafile = "C:/Users/17088/Documents/Soft Robotics Research/Wave Lab Documents/C++/EL - Plot Pendulum/build/Release/Pendulum_Position_Data.dat";
    ...
    while (application.GetDevice()->run()) {
        ...
        //Adding information to dat fie
        mdatafile << time << " " << pendulumBody->GetPos().x() << " " << pendulumBody->GetPos().y() << " " << pendulumBody->GetPos().z() << "\n";
