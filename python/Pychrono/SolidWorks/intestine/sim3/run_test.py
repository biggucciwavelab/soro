...
my_system.Set_G_acc(chrono.ChVectorD(0, -2, 0))
...
material2.SetFriction(0.2)
material2.SetDampingF(mu_b)
material2.SetCompliance(10)
material2.SetComplianceT(0.8)
material2.SetRollingFriction(0.2)
...
for i in range(1, 13):
    ...
    my_shaft = my_system.SearchBody('robo_leg_link-' +str(i)+'/single_bot1-1' )
    if not my_shaft:
    ...
    my_leg = my_system.SearchBody('robo_leg_link-' +str(i)+'/leg-1')
    if not my_leg:
    ...
    link_motor.SetMotorFunction(chrono.ChFunction_Const(-7* chrono.CH_C_2PI))  # 1.0 Hz to rad/s
