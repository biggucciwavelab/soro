# -*- coding: utf-8 -*-
"""
Created on Mon Jun  8 22:06:43 2020
...
n=np.arange(nb-2,5,-6)   #todo: make this calculate properly # array of interior robots
...
#Box3
x_wall=x_wall-(R1/2)*np.cos(3.14/6)
z=-(aspect*R1)-(R1/2)*np.cos(3.14/3)
...
mag = 1.25*mu_f*9.8*(nb*mr+ni*mp)/nb #todo: calculate to be constant #[N]- magnitude of external force applied at each bot
...
while(myapplication.GetDevice().run()):
    ...
    if min(tempx_reset)>8.25*R1 or my_system.GetChTime()>5:
