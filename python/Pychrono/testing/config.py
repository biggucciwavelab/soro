...
##### Spring ##### 
k=17  # spring constant (bots)
rl=0
rlmax=0.1
type_spring='membrane'
...
if control_type=="grab_drag" or control_type=='path_following':
    path_data=True
else:
    path_data=False
