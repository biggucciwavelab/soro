...
# Assembly: C:\Membrane Studies\two_node_octagon\Solidworks\two_node_octagon.SLDASM
...
shapes_dir = 'two_node_4500_study_shapes/' 
...
body_1.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(9.99047126854872e-17,-0.005,6.24500451351651e-17),chrono.ChQuaternionD(1,0,0,0)))
...
body_2.SetName('node_4500-2')
####################################################################################
body_2.SetPos(chrono.ChVectorD(-d*math.cos(ang),0,-d*math.sin(ang)))
####################################################################################
body_2.SetRot(chrono.ChQuaternionD(1,0,0,0))
body_2.SetMass(0.05)
body_2.SetInertiaXX(chrono.ChVectorD(7.18740973418988e-06,1.36844635310913e-05,7.18740973418988e-06))
#body_2.SetInertiaXY(chrono.ChVectorD(-4.64841479715661e-23,4.2849417291625e-23,-1.93870456067116e-23))
body_2.SetInertiaXY(chrono.ChVectorD(0,0,0))
body_2.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(1.35795364428317e-18,0.005,2.43566719530533e-18),chrono.ChQuaternionD(1,0,0,0)))
...
body_3.SetName('node_4500-1')
body_3.SetPos(chrono.ChVectorD(0,0,0))
body_3.SetRot(chrono.ChQuaternionD(1,0,0,0))
body_3.SetMass(0.05)
body_3.SetInertiaXX(chrono.ChVectorD(7.18740973418988e-06,1.36844635310913e-05,7.18740973418988e-06))
#body_3.SetInertiaXY(chrono.ChVectorD(-4.64841479715661e-23,4.2849417291625e-23,-1.93870456067116e-23))
body_3.SetInertiaXY(chrono.ChVectorD(0,0,0))
body_3.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(1.35795364428317e-18,0.005,2.43566719530533e-18),chrono.ChQuaternionD(1,0,0,0)))
...
#body_3.GetMaterialSurfaceNSC().SetImpactC(0.005);
body_3.GetMaterialSurfaceNSC().SetRollingFriction(0.01);
#body_3.GetMaterialSurfaceNSC().SetSpinningFriction(0.005);
...
#   Entity 1: C::E name:  , SW name: two_node_octagon ,  SW ref.type:4 (4)
...
#   Entity 0: C::E name: body_3 , SW name: octagon-1 ,  SW ref.type:4 (4)
#   Entity 1: C::E name:  , SW name: two_node_octagon ,  SW ref.type:4 (4)
...
dA = chrono.ChVectorD(0,1,0)
dB = chrono.ChVectorD(0,1,0)
link_7.Initialize(body_3,body_0,False,cA,cB,dB)
...
cB = chrono.ChVectorD(0,0,0)
dB = chrono.ChVectorD(0,1,0)
link_8.Initialize(body_3,body_0,False,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(0,0,1)
dB = chrono.ChVectorD(0,0,1)
link_9.Initialize(body_3,body_0,False,cA,cB,dB)
...
cB = chrono.ChVectorD(0,0,0)
dB = chrono.ChVectorD(0,0,1)
link_10.Initialize(body_3,body_0,False,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(1,0,0)
dB = chrono.ChVectorD(1,0,0)
link_11.Initialize(body_3,body_0,False,cA,cB,dB)
...
cB = chrono.ChVectorD(0,0,0)
dB = chrono.ChVectorD(1,0,0)
link_12.Initialize(body_3,body_0,False,cA,cB,dA,dB)
...
#   Entity 0: C::E name: body_2 , SW name: octagon-2 ,  SW ref.type:4 (4)
#   Entity 1: C::E name:  , SW name: two_node_octagon ,  SW ref.type:4 (4)
"""
link_13 = chrono.ChLinkMateXdistance()
cA = chrono.ChVectorD(-0.0360359846368469,8.67361737988404e-17,-0.0358046070419418)
cB = chrono.ChVectorD(0,0,0)
dA = chrono.ChVectorD(0,1,0)
dB = chrono.ChVectorD(0,1,0)
link_13.Initialize(body_2,body_0,False,cA,cB,dB)
...
cB = chrono.ChVectorD(0,0,0)
dB = chrono.ChVectorD(0,1,0)
link_14.Initialize(body_2,body_0,False,cA,cB,dA,dB)
