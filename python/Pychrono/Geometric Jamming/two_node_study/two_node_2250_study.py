...
# Assembly: C:\Membrane Studies\two_node_octagon\Solidworks\two_node_2250.SLDASM
...
shapes_dir = 'two_node_2250_study_shapes/' 
...
body_1.SetName('node_2250-2')
####################################################################################
body_1.SetPos(chrono.ChVectorD(-d*math.cos(ang),0,-d*math.sin(ang)))
####################################################################################
body_1.SetRot(chrono.ChQuaternionD(1,0,0,0))
body_1.SetMass(0.05)
body_1.SetInertiaXX(chrono.ChVectorD(2.12193535420978e-06,5.21406250000001e-06,3.38707906189267e-06))
#body_1.SetInertiaXY(chrono.ChVectorD(-3.29986954143534e-23,4.01106341375499e-22,9.52754358800103e-24))
body_1.SetInertiaXY(chrono.ChVectorD(0,0,0))
body_1.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(2.98153135040173e-18,0.005,-3.66002117406838e-18),chrono.ChQuaternionD(1,0,0,0)))
...
body_2.SetName('node_2250-1')
body_2.SetPos(chrono.ChVectorD(0,0,0))
body_2.SetRot(chrono.ChQuaternionD(1,0,0,0))
body_2.SetMass(0.05)
body_2.SetInertiaXX(chrono.ChVectorD(2.12193535420978e-06,5.21406250000001e-06,3.38707906189267e-06))
#body_2.SetInertiaXY(chrono.ChVectorD(-3.29986954143534e-23,4.01106341375499e-22,9.52754358800103e-24))
body_2.SetInertiaXY(chrono.ChVectorD(0,0,0))
body_2.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(2.98153135040173e-18,0.005,-3.66002117406838e-18),chrono.ChQuaternionD(1,0,0,0)))
...
body_3.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(9.93987516716606e-17,-0.005,6.29605236580436e-17),chrono.ChQuaternionD(1,0,0,0)))
...
#   Entity 1: C::E name:  , SW name: two_node_2250 ,  SW ref.type:4 (4)
...
#   Entity 0: C::E name: body_2 , SW name: node_2250-1 ,  SW ref.type:4 (4)
#   Entity 1: C::E name:  , SW name: two_node_2250 ,  SW ref.type:4 (4)
