...
# Assembly: C:\Membrane Studies\two_node_octagon\Solidworks\two_node_5625.SLDASM
...
d = 0.05
#########################################################
shapes_dir = 'two_node_5625_study_shapes/' 
...
body_1.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(9.7704685777152e-17,-0.005,6.29605236580436e-17),chrono.ChQuaternionD(1,0,0,0)))
...
body_2.SetName('node_5625-1')
body_2.SetPos(chrono.ChVectorD(0,0,0))
body_2.SetRot(chrono.ChQuaternionD(1,0,0,0))
body_2.SetMass(0.05)
body_2.SetInertiaXX(chrono.ChVectorD(7.40408372606663e-06,1.27762096064582e-05,6.03620670934006e-06))
#body_2.SetInertiaXY(chrono.ChVectorD(3.38494187585359e-23,5.40978218504142e-22,-3.42356993103851e-23))
body_2.SetInertiaXY(chrono.ChVectorD(0,0,0))
body_2.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(0,0.005,-1.39344310700301e-18),chrono.ChQuaternionD(1,0,0,0)))
...
pt_vect.push_back(chrono.ChVectorD(0.00527910607256971,0.01,-0.0265398584417511))
pt_vect.push_back(chrono.ChVectorD(0.0224994055784104,0.01,-0.0150336221733761))
pt_vect.push_back(chrono.ChVectorD(0.0224994055784104,0.01,0.0150336221733761))
pt_vect.push_back(chrono.ChVectorD(0.00527910607256971,0.01,0.0265398584417511))
pt_vect.push_back(chrono.ChVectorD(-0.00527910607256971,0.01,0.0265398584417511))
pt_vect.push_back(chrono.ChVectorD(-0.0224994055784104,0.01,0.0150336221733761))
pt_vect.push_back(chrono.ChVectorD(-0.0224994055784104,0.01,-0.0150336221733761))
pt_vect.push_back(chrono.ChVectorD(-0.00527910607256971,0.01,-0.0265398584417511))
pt_vect.push_back(chrono.ChVectorD(0.00527910607256971,0,-0.0265398584417511))
pt_vect.push_back(chrono.ChVectorD(0.0224994055784104,0,-0.0150336221733761))
pt_vect.push_back(chrono.ChVectorD(0.0224994055784104,0,0.0150336221733761))
pt_vect.push_back(chrono.ChVectorD(0.00527910607256971,0,0.0265398584417511))
pt_vect.push_back(chrono.ChVectorD(-0.00527910607256971,0,0.0265398584417511))
pt_vect.push_back(chrono.ChVectorD(-0.0224994055784104,0,0.0150336221733761))
...
body_3.SetName('node_5625-2')
####################################################################################
body_3.SetPos(chrono.ChVectorD(-d*math.cos(ang),0,-d*math.sin(ang)))
####################################################################################
body_3.SetRot(chrono.ChQuaternionD(1,0,0,0))
body_3.SetMass(0.05)
body_3.SetInertiaXX(chrono.ChVectorD(7.40408372606663e-06,1.27762096064582e-05,6.03620670934006e-06))
#body_3.SetInertiaXY(chrono.ChVectorD(3.38494187585359e-23,5.40978218504142e-22,-3.42356993103851e-23))
body_3.SetInertiaXY(chrono.ChVectorD(0,0,0))
body_3.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(0,0.005,-1.39344310700301e-18),chrono.ChQuaternionD(1,0,0,0)))
...
#   Entity 1: C::E name:  , SW name: two_node_5625 ,  SW ref.type:4 (4)
...
#   Entity 0: C::E name: body_2 , SW name: node_5625-1 ,  SW ref.type:4 (4)
#   Entity 1: C::E name:  , SW name: two_node_5625 ,  SW ref.type:4 (4)
