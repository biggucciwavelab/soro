...
file="F:/Soro_chrono/python/Pychrono/Strings/Strings_final/robot_data_"+sim+"/"
...
if single_entry==False:
    #phi.create_images_ball_square(geom)
    phi.create_images_ball(geom)
    directory='F:/Soro_chrono/python/Pychrono/Strings/Strings_final/'+sim+'_video_'
    export='F:/Soro_chrono/python/Pychrono/Strings/Strings_final/'+sim+'field_'
    file='jpg'
    ...
    phi.plot_mag_velocity()

# (FXB,FZB,FZP,FXP)=phi.find_pressure()
# phi.plot_pressure(FXB,FZB,FZP,FXP)
# phi.ball_plots()
# phi.crucial_plots_2()
# directory='F:/Soro_chrono/python/Pychrono/Strings/Strings_final/'+sim+'_video_'
# export='F:/Soro_chrono/python/Pychrono/Strings/Strings_final/'+sim+'field_'
