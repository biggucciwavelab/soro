...
if control_type=='grab_drag' or  control_type=="pot_field_grab" or control_type=='grab_drag_A' or control_type=='grab_drag_2'or control_type=="verify":
    name='ballFx.csv'
    filename=path+name
...
if control_type=="path_following" or control_type=="grab_drag" or control_type=="grab_drag_A" or control_type=="grab_drag_2" or control_type=="shape_formation": 
    name='pathx.csv'
    filename=path+name
...
results=robot_plots(nb,results_dir,sim,data0=data0,data1=data1,data2=data2,data3=data3,data4=None,data5=data5,data6=data6,data7=data7,data8=data8,data9=data9,data10=data10,data11=data11,data12=data12,data13=data13,data14=data14,data15=data15,data16=data16,data17=data17,data18=data18,data19=data19,data20=None,data21=None,data22=None,data23=None,data24=None,data25=None,data26=None)   
