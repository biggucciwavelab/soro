...
controls=sim_obj.controller(name,my_system,bots,Psi,path,ball=ball,interior=interior)

# Create simulation
sim = sim_obj.simulate(name,my_system,bots,interior,controls,my_rep,path,ball=ball)
