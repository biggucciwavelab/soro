...
class Interiors:
    def __init__(self,name,my_system,body_floor,path):
        ...
        self.particle_material = self.Material(0.2)
...
class floor:
    def __init__(self,name,my_system,path):
        ...
        self.material1 = self.Material(.001)
...
class import_data:
     ...
     def create_snap_shot(self,entry,membrane):
        ...
        plt.rcParams['axes.linewidth'] = .1
        plt.rcParams["text.usetex"] = True 
        fig, ax = plt.subplots(figsize=(1.1,1.1),dpi=300,constrained_layout=True)
        #plt.tight_layout()
        ...
        #fig.ax.get_yaxis().set_visible(False)
        ax.set_axis_off()
