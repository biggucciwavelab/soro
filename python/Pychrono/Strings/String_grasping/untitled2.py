...
# body_A= chrono.ChBodyEasyMesh(chrono.GetChronoDataFile(path+'part6.obj'), # mesh filename
#                               7000,             # density kg/m^3
...
# mesh_for_visualization.LoadWavefrontMesh(chrono.GetChronoDataFile(path+'part6.obj'))
...
# mesh_for_collision.LoadWavefrontMesh(chrono.GetChronoDataFile(path+'part6.obj'))
# # Optionally: you can scale/shrink/rotate the mesh using this:
