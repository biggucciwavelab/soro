...
class pymunkEnv(Env):
    ...
    def __init__(self, dt, ppm, screenHeight, screenWidth, 
        ...
        #### Gym API
        self.state_size = self.numBots*8 #+ 8  # botRePosition (x,y), botVel (x,y), botCurrentAction(x,y), objectPos(x,y), botVel(x,y), not including square information
