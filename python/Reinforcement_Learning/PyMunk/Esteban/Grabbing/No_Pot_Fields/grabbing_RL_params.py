...
from grabbing_env_params import maxNumSteps, numBots
...
botTrainingSteps = {#3:1_000_000,
                    ...
                    # 10:10_000_000, # For actual training
                    # 15:20_000_000,
                    # 30:30_000_000}
                    # 30:50_000_000}
                    30:5_000_000
...
batch_size = 100                               # Number of minibatches at each update. Thus the minibatchsize = batchsize//minibatches
...
# Pass a pretraining location. 
"""If None is passed, the no pretraining is done on model"""
pretrained_model = './Pretrained_Model/Pretrained_Grabber_model.zip'
