...
from Environment_PF import calc_JAMoEBA_Radius, Convert, createVideo, pymunkEnv
...
saveVideo = False
dataCollect = False
experimentName = "Pretrain Test Determinstic" # Make sure the name has {} to allow for additional formatting!
