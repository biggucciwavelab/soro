...
if __name__ == '__main__':
    ...
    from cont_training.Experiment_18_env_params import *
    from cont_training import Experiment_18_env_params, Environment_Experiment_18
    grabbing_env_params, Grabbing_Environment_PF = Experiment_18_env_params, Environment_Experiment_18
    old_model = 'cont_training/Experiment_18_agent.zip'
    experimentNum = 21 # The new experiment number
    ...
    copyfile(Grabbing_Environment_PF.__file__,savefile+'Environment_Experiment_{}.py'.format(str(experimentNum)))
