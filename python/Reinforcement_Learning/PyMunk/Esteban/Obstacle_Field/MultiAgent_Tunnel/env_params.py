...
# Importing the environment and custom functions
from Environment import parallel_env, reg_env, calc_JAMoEBA_Radius, Convert, createVideo, save_runtime
...
saveVideo = False
dataCollect = False
experimentName = "Test 5" # WILL BE OVERWRITTEN IF 'grabbing_RL_params.py' IS CALLED
