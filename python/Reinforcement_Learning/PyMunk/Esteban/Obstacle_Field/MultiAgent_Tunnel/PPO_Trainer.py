...
if __name__ == '__main__':
    ...
    copyfile(RL_params.__file__,savefile+'Experiment_{}_RL_params.py'.format(str(experimentNum)))
    ...
    # model = PPO.load('Experiment_1_agent.zip', env, tensorboard_log=savefile, verbose=1)
