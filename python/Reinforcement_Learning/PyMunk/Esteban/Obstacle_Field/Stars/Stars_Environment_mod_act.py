...
This script contains the code for an obstacle field with stars in the observation, but a shortened action space.
"""
...
class pymunkEnv(Env):
    ...
    def __init__(self, dt, ppm, screenHeight, screenWidth, maxNumSteps, R, 
        ...
        self.state_size = self.numBots*6 # botRePosition (x,y), botVel (x,y), externalForcesFelt
        self.action_size = 2
    ...
    def getOb(self, ac):
        ...
        observation = np.concatenate((botPos.flatten(), botVel.flatten(), extForces))
