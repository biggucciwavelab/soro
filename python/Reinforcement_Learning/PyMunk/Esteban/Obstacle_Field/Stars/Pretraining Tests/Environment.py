...
class pymunkEnv(Env):
    ...
    def __init__(self, dt, ppm, screenHeight, screenWidth, maxNumSteps, R, 
        ...
        self.single_interior = True # If true, the interior will just be a single object
        ...
        # self.state_size = 5 # Single bot observation
    ...
    def reset(self):
        ...
        observation, _, self.previousDistance, _ = self.getOb2(ac)
    ...
    def step(self, ac):
        ...
        if np.all(self.distance_storage==0):
            ...
            self.master_bot = new_master_bot
        ...
        # Gather information
        obs, systemCenter, distanceToTarget, sysNormForce = self.getOb2(ac)
    ...
    def getObSingle(self):
        """
        Returns the reward for ONLY the master bot
        """
