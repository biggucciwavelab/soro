...
experimentNum = "1e-LinearDecayb"
        
# Depending on how many bots there are in the system, 
# the number of training time steps will vary

training_timesteps = 50_000_000

divisor = 5 # Number of times to stop mid-training to observe results
...
n_steps = 20_000                                # Number of steps to run in each environment per update. Batchsize = n_steps*n_env
...
batch_size = 1000                             # Number of minibatches at each update.
noptepochs = 20                                 # Number of epochs each update
cliprange = 0.2                                # Cliprange for PPO
seed = 54321                                  # Seed for neural network initialization
