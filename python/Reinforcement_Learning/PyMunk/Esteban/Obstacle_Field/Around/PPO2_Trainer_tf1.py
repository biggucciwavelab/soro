...
if __name__ == '__main__':
    ...
    copyfile(RL_params_tf1.__file__,savefile+'Experiment_{}_RL_params.py'.format(str(experimentNum)))
    copyfile(env_params.__file__,savefile+'Experiment_{}_env_params.py'.format(str(experimentNum)))
    copyfile(__file__, savefile+'Experiment_{}_trainer.py'.format(str(experimentNum)))
