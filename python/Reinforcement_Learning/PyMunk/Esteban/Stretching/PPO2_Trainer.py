...
if __name__ == '__main__':
    ...
    from stretching_RL_params import *
    ...
    import stretching_env_params, stretching_RL_params, Stretching_Environment
    copyfile(Stretching_Environment.__file__,savefile+'Environment_Experiment_{}.py'.format(str(experimentNum)))
    copyfile(stretching_RL_params.__file__,savefile+'Experiment_{}_RL_params.py'.format(str(experimentNum)))
    copyfile(stretching_env_params.__file__,savefile+'Experiment_{}_env_params.py'.format(str(experimentNum)))
