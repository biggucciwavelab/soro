...
class pymunkEnv(Env):
    ...
    def __init__(self, dt, ppm, screenHeight, screenWidth, 
        ...
        objectX = self.width/2 # Start in the center of the environment
        ...
        self.start_options = [
            ...
            [objectX, objectY] # Start in the center, engulfing the object
        ]
    ...
    def calcRew(self, distanceToTarget, distanceToSquare):
        ...
        rew = normAppliedForce - netAppliedForce*.65
...
def createSlot(space, squareLength, friction, squarePosition, wallThickness):
    """
