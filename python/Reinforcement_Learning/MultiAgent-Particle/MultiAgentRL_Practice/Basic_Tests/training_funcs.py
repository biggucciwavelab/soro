...
def train(arglist):
    with U.single_threaded_session(): # Runs the tensorflow graph on a single CPU
        # Create environment
        env = make_env(arglist.scenario, arglist, arglist.benchmark) # Creates and returns an environment
...
def get_args(
    ...
    scenario = 'simple',    # Name of the scenario script (from multi-agent particle simulator)
    max_episode_len = 25,   # Maximum episode length
    num_episodes = 60_000,  # Number of episodes to train over
    num_adversaries = 0,    # Number of adversaries
    ...
    argsdict = {
    'scenario' : scenario,                # Name of the scenario script (from multi-agent particle simulator)
    'max_episode_len' : max_episode_len,  # Maximum episode length
    'num_episodes' : num_episodes,        # Number of episodes to train over
    'num_adversaries' : num_adversaries,  # Number of adversaries
